...
let getPost = (oncFunc) => {
  const posts = [
    ...
    { 
      ...
      body: <div><div>Mivel szerény és szögletes személy vagyok nem szoktam bevallani de én maga a Klán Háború királya vagyok, ki mindig nyer és jó tanácsaival csapatait is győzelemre vezeti!</div><Button children={"Kérj tanácsot!"} className="btn-tanacs" onClick={oncFunc}></Button></div>
    },
  ];
